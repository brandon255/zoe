...
import { DEFAULT_PERSONA } from './data/patientSimulatorPersona';
...
import type { VoiceIntent, LayerId, FigureSource } from './types';
...
export default function App() {
  ...
  const encounter = useEncounter({
    ...
    onAnatomyMentioned: (layers) => {
      // When patient or doctor mentions anatomy, briefly highlight those layers
      ...
      >
        <Suspense fallback={null}>
          <Scene
            ...
            examTools={mode === 'encounter' ? encounter.activeTools : undefined}
