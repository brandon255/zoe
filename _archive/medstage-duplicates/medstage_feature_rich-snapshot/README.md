...
**University of Utah Medical Center** · v0.2 · LLM-powered
...
Built for the stakeholder sign-off demo, designed to extend into a full anatomy learning platform.
...
Code: MIT (or your preference — adjust for U of Utah).
...
For an internal U of Utah prototype, attribution is sufficient. For a distributed product, consult U of Utah's tech transfer / IP office.
...
7. **Close:** Mention U of Utah Medical Center, stakeholder sign-off, what's next
